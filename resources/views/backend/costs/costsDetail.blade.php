          ...
          <div class="panel-body">
            ...
            <div class="box-tools pull-right">
              <ol class="breadcrumb">
                ...
                <li class="active">Sản phẩm đã bán</li>
              </ol>
            </div>
          </div>
        </div>
             ...
             <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {{number_format($post->total_order)}}
                  </td>
                  <td>
                    {{ number_format(($post->costs+$post->OtherCosts)*$post->total_order )}}₫
                  </td>
                  <td>
                    {{ number_format(($post->price_ouput*$post->total_order)-($post->costs+$post->OtherCosts)*$post->total_order )}}₫
                  </td>
