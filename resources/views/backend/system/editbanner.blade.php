...
<!-- Main content -->
  <section class="content">
    <!-- Default box -->
    <div class="box">
      <form action="{{ route('backend.banner-add-edit-post') }}" method="POST">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
				<div class="form-group">
					...
					<div class="radio">
						<label>
							<input type="radio" name="status" value="1" @if ($image->status==1)
								checked="true" 
							@endif />
							Hiển thị
						</label>
					...
					<div class="radio">
						<label>
							<input type="radio" name="status" value="0" @if ($image->status==0)
								checked="true" 
							@endif />
							Ẩn
						</label>
				...
				<div class="form-group">
					...
					<div class="thumbnail" id="thumbnail">
				      ...
				      <img id="thumb-image" src="uploads/{{$image->link}}" class="" style="width: 100%" />
				      </a>
				    </div>
				</div>
            </div>
