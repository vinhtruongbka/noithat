...
class UserController extends Controller
{
	...
	public function postRegister(Request $req){
	   ...
	   Auth::attempt(['email' => $email,'password' => $pass]);
		...
		return redirect()->route('Fronted.getIndex')->with('info','Đăng ký tài khoản thành công');
	}
    ...
    {
        $input = $request->all();
        Mail::send('mail.mailfb', array('email'=>$input["email"]), function($message){
	        $message->to('vinhtruongbka@gmail.com', 'Visitor')->subject('Visitor Feedback!');
	    });
